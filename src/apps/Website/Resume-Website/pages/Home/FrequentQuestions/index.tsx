...
const items: FAQItem[] = [
  ...
  },
  {
    ...
    description: (
      <Trans>
        ...
        worked for, I had to get up to speed quickly as I was one of the{' '}
  ...
  },
  {
    ...
    description: (
      <Trans>
        We had a data-heavy application that was experiencing slow load times. I{' '}
  ...
  },
  {
    ...
    description: (
      <Trans>
        ...
        <b>seamlessly</b>, resulting in a smooth and efficient user experience.
        The project was a great <b>success</b>, improving user engagement and{' '}
        <b>increasing sales</b> for the platform.
      </Trans>
    ),
  },
  {
    ...
    description: (
      <Trans>
        ...
        <b>photographing</b> landscapes, which helps me stay <b>creative</b> and
        refreshed. I also enjoy working on side projects that involve{' '}
        <b>engineering</b>.
      </Trans>
    ),
  },
