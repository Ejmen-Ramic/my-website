...
const items: TestimonialProps[] = [
  {
    ...
    description: `Working with Ejmen has been a game-changer. His ability to identify,
  ...
  },
  {
    ...
    description: `Ejmen brings a rare mix of technical expertise and innovative thinking.
  ...
  },
  {
    ...
    description: `Ejmen is a diligent and gifted coder, but what stuck out to me is his
