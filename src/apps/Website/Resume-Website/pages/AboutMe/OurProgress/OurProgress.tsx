  ...
  return (
    <VStack w={'full'} px={{ lg: 40 }} spacing={'50px'}>
      ...
      <SimpleGrid w={'full'} columns={{ base: 1, md: 3 }} spacing={{ base: 5, lg: 8 }}>
        <StatsCard title={t`Visitors`} stat={'2450 website visitors'} icon={<BsPerson size={'3em'} />} />
        <StatsCard title={t`Registered`} stat={'900 registered users'} icon={<FaAddressCard size={'3em'} />} />
        <StatsCard title={t`Photographs`} stat={'400 high quality images'} icon={<FaCamera size={'3em'} />} />
      </SimpleGrid>
    </VStack>
  )
}
