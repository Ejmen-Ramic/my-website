import type { IconProps as ChakraIconProps, ResponsiveValue } from '@chakra-ui/react'
...
export type IconViewBox = string | { minX: number; minY: number; width: number; height: number }
