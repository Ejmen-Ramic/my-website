...
const ContactForm = () => {
  const { hasCopied, onCopy } = useClipboard('webxarkitect@gmail.com')
  ...
  return (
    ...
    >
      <FadeInView>
        <Box borderRadius={'lg'} m={{ base: 5, md: 16, lg: 10 }} mb={{ base: 20 }} p={{ base: 5, lg: 16 }}>
          <Box>
            <VStack spacing={{ base: 4, md: 8, lg: 20 }}>
              ...
              <Stack spacing={{ base: 4, md: 8, lg: 20 }} direction={{ base: 'column', md: 'row' }}>
                <Stack align={'center'} justify={'space-around'} direction={{ base: 'row', md: 'column' }}>
                  ...
                  <Link href='https://www.linkedin.com/company/webxarkitect/'>
                    <IconButton
                      aria-label={'linkedin'}
                      variant={'ghost'}
                      size={'lg'}
